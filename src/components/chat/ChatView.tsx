          ...
          <div className="flex items-start gap-2 overflow-hidden">
            ...
            <div className="space-y-0.5 leading-snug">
              ...
              <p className="text-[10px] sm:text-[11px] text-amber-800/90 leading-tight">
                {language === 'bn'
                  ? 'জেপিএমসি সাইন্যাপস চ্যাটের সকল বার্তা ও ফাইল সর্বোচ্চ ৭২ ঘণ্টা পর্যন্ত সংরক্ষিত থাকে। ব্যবহারকারী কোনো বার্তা মুছে ফেললেও প্রাতিষ্ঠানিক জবাবদিহিতার জন্য অবশিষ্ট সময় পর্যন্ত অনুমোদিত অ্যাডমিন নজরদারিতে থাকবে। ৭২ ঘণ্টা পূর্ণ হওয়ার পর সার্ভার থেকে স্থায়ীভাবে স্বয়ংক্রিয়ভাবে মুছে যাবে।'
